...
/**
 * Manages a Claude Code child process with event-based output handling.
 * Provides graceful shutdown with SIGTERM → timeout → SIGKILL fallback.
 */
 ...
 */
export function setupProcessCleanup(claudeProcess: ClaudeProcess): void {
  const cleanup = async () => {
